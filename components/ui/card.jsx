...
function CardFooter({ className, ...props }) {
    return (<div data-slot="card-footer" className={cn("flex items-center rounded-b-xl border-t border-primary/15 bg-primary/5 p-(--card-spacing)", className)} {...props}/>);
}
