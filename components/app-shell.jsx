...
export function AppShell() {
  ...
  return (
    <div className="flex min-h-dvh flex-col bg-background">
      <header className="sticky top-0 z-20 border-b border-primary/20 bg-primary text-primary-foreground pt-safe">
      ...
      <nav className="fixed inset-x-0 bottom-0 z-20 border-t border-border bg-card/95 backdrop-blur pb-safe">
        <div
