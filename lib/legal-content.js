...
export const privacySections = [
  ...
  },
  {
    ...
    body: [
      "Dados de conta: nome, e-mail, senha criptografada pelo provedor de autenticacao, status de conta, perfil de administrador e data de criacao.",
      ...
      "Dados tecnicos e de seguranca: identificadores de usuario, sessoes de autenticacao, registros de erro, logs operacionais e metadados necessarios para auditoria e suporte.",
    ],
  },
  {
    ...
    body: [
      ...
      "Permitir que o proprio usuario e administradores autorizados gerenciem perfis, escalas, usuarios ativos e registros vinculados.",
  ...
  },
  {
    ...
    body: [
      ...
      "Legitimo interesse: para seguranca, prevencao a fraude, melhoria operacional, logs tecnicos e suporte, sempre com avaliacao de impacto e respeito aos direitos dos titulares.",
  ...
  },
  {
    ...
    body: [
      ...
      "Dados nao sao vendidos. Compartilhamentos com empregador, administradores internos, autoridades ou terceiros so devem ocorrer quando houver autorizacao, obrigacao legal, protecao de direitos ou necessidade operacional legitima.",
    ],
  },
  {
  ...
  },
  {
    title: "8. Seguranca",
    body: [
      "O sistema aplica autenticacao por e-mail e senha, controle de acesso por perfil, politicas de seguranca no banco de dados e restricao de leitura e escrita por usuario autenticado.",
      "Administradores devem conceder acessos apenas a pessoas autorizadas, revisar permissoes periodicamente, manter credenciais protegidas e registrar incidentes de seguranca.",
...
export const termsSections = [
  {
    ...
    body: [
      ...
      "Caso utilize o sistema em nome de uma empresa, o usuario declara possuir autorizacao para registrar e administrar informacoes vinculadas a essa organizacao.",
    ],
  },
  {
  ...
  {
    title: "3. Contas, administradores e responsabilidades",
    body: [
      "Contas comuns podem visualizar e gerenciar seus proprios dados, conforme permissoes do sistema.",
      "Administradores podem criar, atualizar, ativar, desativar e consultar usuarios e registros quando houver autorizacao organizacional e base legal adequada.",
      "A empresa ou responsavel controlador deve definir quem pode ser administrador, manter trilhas de decisao e garantir que o acesso seja compativel com a necessidade de cada funcao.",
    ],
  },
  {
...
export const complianceSections = [
  ...
  },
  {
    ...
    body: [
      "Manter registro atualizado de categorias de dados tratados: conta, perfil, jornada, justificativas, relatorios, logs e erros.",
  ...
  },
  {
    ...
    body: [
      ...
      "Row Level Security no banco para limitar acesso por usuario autenticado e administradores.",
      "Separacao entre usuarios comuns e administradores.",
      "Desativacao de contas sem excluir historico imediatamente.",
      "Logs e tabelas de erro com vinculo opcional ao usuario para auditoria tecnica.",
    ],
  },
  {
    ...
    body: [
      ...
      "Revisar periodicamente administradores e usuarios ativos.",
      "Definir politica de retencao para registros de jornada, justificativas, logs e contas inativas.",
