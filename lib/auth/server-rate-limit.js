/**
 * Rate limit simples em memoria para rotas server-side de autenticacao.
 *
 * Em ambientes serverless, a protecao e local a instancia; ela reduz abuso imediato,
 * mas nao substitui limites globais do provedor.
 */
