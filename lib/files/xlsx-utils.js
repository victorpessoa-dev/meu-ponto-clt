/**
 * Utilitarios para importar e exportar registros de ponto em XLSX.
 *
 * Aceita variações comuns de nomes de colunas e formatos de data/hora para reduzir atrito
 * quando a planilha vem de sistemas ou modelos diferentes.
 */
...
/**
 * Remove acentos, espacos e pontuacao para comparar cabecalhos de planilha com tolerancia.
 */
...
/**
 * Indexa uma linha usando cabecalhos normalizados.
 */
...
/**
 * Encontra o primeiro valor preenchido entre os aliases aceitos para uma coluna.
 */
...
/**
 * Identifica se a linha possui algum campo relevante para importacao.
 */
...
/**
 * Ignora linhas vazias ou de totalizacao geradas por planilhas de ponto.
 */
...
/**
 * Converte o numero serial do Excel para data ISO.
 */
...
/**
 * Formata Date usando o fuso local para preservar o dia exibido na planilha.
 */
...
/**
 * Procura um ano explicito nas linhas antes de usar o ano informado pelo usuario.
 */
...
/**
 * Converte datas vindas do Excel ou de texto para YYYY-MM-DD.
 *
 * @param {*} value Valor da celula.
 * @param {number} defaultYear Ano usado quando a data nao traz ano.
 * @returns {string|null}
 */
...
/**
 * Converte horarios do Excel, Date ou texto para HH:MM.
 *
 * Retorna string vazia para celulas vazias e null para valores invalidos.
 */
...
/**
 * Confirma se a linha importada tem pelo menos uma batida preenchida.
 */
...
/**
 * Transforma linhas de planilha em registros de ponto validados.
 */
...
/**
 * Converte registros internos para colunas amigaveis no arquivo exportado.
 */
